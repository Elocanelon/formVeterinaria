    ...
    return(
        ...
        <form className="bg-white shadow-md rounded-lg px-10 py-5">
            <div>
                ...
                <input type="text" id="Nombre" placeholder="Nombre de mascota" className="border-2 w-full pt-2 mt-2 placeholder-gray-400 rounded-md" />
            </div>
            <div className="mt-5">
                <label className="block text-gray-700 uppercase font-bold" htmlFor="Propietario">Propietario:</label>
                <input type="text" id="Propietario" placeholder="Nombre del propietario" className="border-2 w-full pt-2 mt-2 placeholder-gray-400 rounded-md" />
            </div>
            <div className="mt-5">
                <label className="block text-gray-700 uppercase font-bold" htmlFor="Email">Correo electronico</label>
                <input type="email" id="Email" placeholder="Correo propietario" className="border-2 w-full pt-2 mt-2 placeholder-gray-400 rounded-md" />
            </div>
            <div className="mt-5">
                <label className="block text-gray-700 uppercase font-bold" htmlFor="Alta">Fecha alta</label>
                <input type="date" id="Alta" placeholder="Alta" className="border-2 w-full pt-2 mt-2 placeholder-gray-400 rounded-md" />
            </div>
            <div className="mt-5">
                <label className="block text-gray-700 uppercase font-bold" htmlFor="Sintomas">Sintomas</label>
                <textarea type="text" id="Sintomas" placeholder="Nombre de mascota" className="border-2 w-full pt-2 mt-2 placeholder-gray-400 rounded-md" />
            </div>
